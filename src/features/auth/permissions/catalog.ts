...
export const permissionModuleCatalog: PermissionCatalogModule[] = [
  ...
  },
  {
    ...
    permissions: [
      ...
      {
        action: 'archive',
        name: 'Archive departments',
        description: 'Archive departments that should no longer be used.',
      },
    ],
  },
  {
    ...
    permissions: [
      ...
      {
        action: 'archive',
        name: 'Archive positions',
        description: 'Archive positions that should no longer be used.',
      },
    ],
  },
  {
    ...
    permissions: [
      ...
      },
      {
        ...
        description: 'Archive locations that should no longer be used.',
      },
    ],
  },
  {
