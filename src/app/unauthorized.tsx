          ...
          <div className="flex flex-col gap-5 sm:flex-row sm:items-start sm:justify-between">
            <div>
              ...
              <p className="mt-3 max-w-2xl text-sm leading-6 text-slate-600">
                Sign in with an account that has access, or return to the home
                page.
              </p>
            </div>

            <span className="inline-flex shrink-0 rounded-lg border border-amber-200 bg-amber-50 px-3 py-2 text-sm font-semibold text-amber-700">
              401
            </span>
          </div>
