  ...
  return (
    <section style={{ scrollMarginTop: 96 }}>
      ...
      >
        ...
        <Typography.Text type='secondary'>Tenant, user, access, subscription, and organization visibility from available Prisma data.</Typography.Text>
      </Space>
...
function Metric({ title, value, suffix, icon }: { title: string; value: number; suffix?: string; icon: ReactNode }) {
