          ...
          <div className="flex flex-col gap-5 sm:flex-row sm:items-start sm:justify-between">
            <div>
              ...
              <p className="mt-3 max-w-2xl text-sm leading-6 text-slate-600">
                The page may have moved, been deleted, or you may not have
                access to it.
              </p>
            </div>

            <span className="inline-flex shrink-0 rounded-lg border border-slate-200 bg-slate-50 px-3 py-2 text-sm font-semibold text-slate-700">
              404
            </span>
          </div>
