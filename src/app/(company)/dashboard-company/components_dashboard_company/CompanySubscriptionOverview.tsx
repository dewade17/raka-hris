        ...
        <Row gutter={[18, 18]} align="middle">
          <Col xs={24} lg={8}>
            <Space direction="vertical" size={10}>
              <DashboardToneTag tone="info" label="Plan status" statusText={data.status} />
            ...
            <Row gutter={[16, 16]}>
              <Col span={12}>
                <Statistic
                  ...
                  prefix={<UsersRound size={18} aria-hidden="true" focusable="false" />}
              ...
              <Col span={12}>
                <Statistic
                  ...
                  prefix={<CreditCard size={18} aria-hidden="true" focusable="false" />}
                  styles={getDashboardStatisticStyles()}
                />
              </Col>
            </Row>
